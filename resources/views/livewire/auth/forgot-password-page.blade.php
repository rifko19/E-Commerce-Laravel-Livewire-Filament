                ...
                <div class="p-4 sm:p-7">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='save'>
                            @if (session('success'))
                                <div class="mt-2 bg-green-500 text-sm text-white rounded-lg p-4 mb-4 flex justify-between items-center"
                                    role="alert">
                            ...
                            @if (session('error'))
                                <div class="mt-2 bg-red-500 text-sm text-white rounded-lg p-4 mb-4 flex justify-between items-center"
                                    role="alert">
